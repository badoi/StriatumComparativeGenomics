...
save_fn = here(DATADIR,'Mouse_Stanley/Stanley2020_mouse_striatum_msns.h5Seurat')
...
save_fn2 = here(DATADIR,'Mouse_Stanley/Stanley2020_mouse_striatum_msns.hgGenes.h5Seurat')
SaveH5Seurat(obj2, save_fn2, overwrite = T)
