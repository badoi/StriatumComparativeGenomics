...
#NOT FILTERING DOUBLETS, DONE EARLIER
...
proj$integrated_clusters = 
  ifelse(is.na(proj$integrated_clusters), 
         proj$Clusters2, proj$integrated_clusters)
table(proj$Sample, proj$integrated_clusters)

proj$integrated_subclusters =
  ifelse(is.na(proj$integrated_subclusters), 
         proj$Clusters2, proj$integrated_subclusters)
