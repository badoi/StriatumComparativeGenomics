...
save_fn = here(DATADIR,'Rat_Phillips/Phillips2023_snRNA_filtered_SeuratObj_N8.h5Seurat')
...
# get only the Acute samples, which were from the Savell et al. 2020 paper
obj2 = subset(obj, Dataset=='Acute')
...
save_fn2 = here(DATADIR,'Rat_Phillips/Phillips2023_snRNA_filtered_SeuratObj_N4.rds')
saveRDS(obj4, save_fn2, overwrite = T)
